...
//        CrawlerGoodsInfo crawlerGoodsInfo = new CrawlerGoodsInfo();
//        try {
//            System.getProperties().setProperty("webdriver.chrome.driver", "C:\\Users\\爱妻金雯\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe");
//            ChromeDriver chormeDriver = new ChromeDriver();
//
//
//            String crawUrl = CommonConstants.CRAW_URL + comPriceInfo.getComStoreId();
////            Document document = HttpUtils.rawDataHomePage(crawUrl);
//            chormeDriver.get(crawUrl);
//            List<WebElement> priceElements = chormeDriver.findElements(By.className(CommonConstants.CRAW_PRICE_LABEL));
//            List<WebElement> comStoreNameElements = chormeDriver.findElements(By.className(CommonConstants.CRAW_GOODS_NAME_LABEL));
////            Element priceElement = document.getElementsByClass(CommonConstants.CRAW_PRICE_LABEL).first();
////            Elements comStoreNameElements = document.getElementsByClass(CommonConstants.CRAW_GOODS_NAME_LABEL);
//
//            if (comStoreNameElements != null) {
