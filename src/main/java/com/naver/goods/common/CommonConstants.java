package com.naver.goods.common;

public class CommonConstants {

    //爬虫比价链接前缀
    public final static String CRAW_URL = "https://search.shopping.naver.com/catalog/";

    //爬虫比价价格标签
    public final static String CRAW_PRICE_LABEL = "lowestPrice_num__A5gM9";
